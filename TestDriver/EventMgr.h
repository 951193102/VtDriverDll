...
public:
    ...
    virtual std::string GetProcessName(void) const { return m_UniqueProcess->m_ProcessName; }
    virtual std::string GetProcessPath(void) const { return m_UniqueProcess->m_ImagePath; }
    virtual std::string GetEventPath(void) const { return m_UniqueProcess->m_ImagePath; }
    virtual ULONG64 GetEventTime(void) const { return m_EventTime; }
    virtual std::string GetDisplayName(void) const { return m_UniqueProcess->GetDisplayName(); }
    virtual std::string GetEventName(void) const;
    virtual std::string GetEventClassName(void) const;    
    virtual void GetFullArgument(std::string &str) const { str = ""; }
    virtual void GetBriefArgument(std::string &str) const { str = ""; }
    virtual void GetBriefResult(std::string &str) const { str = ""; }
...
public:
    ...
    virtual void GetBriefResult(std::string &str) const;
protected:
...
public:
    ...
    virtual std::string GetEventPath(void) const { return m_TargetProcess->m_ImagePath; }
    virtual void GetBriefArgument(std::string &str) const;
    virtual void GetFullArgument(std::string &str) const;
protected:
...
public:
    ...
    virtual std::string GetEventPath(void) const { return m_FilePath.GetQString(); }
protected:
...
public:
    ...
    virtual std::string GetEventPath(void) const { return ""; }
...
public:
    ...
    virtual std::string GetEventPath(void) const { return m_ImagePath.GetQString(); }
...
public:
    ...
    virtual std::string GetEventPath(void) const { return m_ImagePath; }
...
public:
    ...
    virtual std::string GetEventPath(void) const { return m_ModuleFile.GetQString(); }
...
typedef std::list<CUniqueEvent *> QEventList;

class CEventWorker 
{

public:
    explicit CEventWorker();
...
public:
    ...
    std::string m_EventClassNames[EVClass_Maximum];
    std::string m_EventNames[EV_Maximum];
    std::string m_FltKeyTable[FltKey_Max];
    std::string m_FltRelTable[FltRel_Max];
    std::string m_FltIncTable[2];
...
public:
    void OnCallStack(std::string & data);
    void OnPsCreateProcess(std::string &data);
    void OnPsCreateThread(std::string &data);
    void OnPsLoadImage(std::string& data);
    void OnNtLoadDriver(std::string &data);
    void OnNtQuerySystemInfo(std::string &data);
    void OnNtOpenProcess(std::string &data);
    void OnNtOpenThread(std::string &data);
    void OnNtTerminateProcess(std::string& data);
    void OnNtAllocateVirtualMemory(std::string& data);
    void OnNtReadWriteVirtualMemory(std::string &data);
    void OnNtProtectVirtualMemory(std::string& data);
    void OnNtQueryVirtualMemory(std::string &data);
    void OnNtCreateOpenMutant(std::string &data);
    void OnNtCreateOpenDirectoryObject(std::string& data);
    void OnNtQueryDirectoryObject(std::string& data);
    void OnNtUserSetWindowsHook(std::string &data);
    void OnNtUserFindWindow(std::string &data);
    void OnNtUserInternalGetWindowText(std::string& data);
    void OnNtUserGetClassName(std::string& data);
    void OnFsCreateFile(std::string &data);
    void OnFsCloseFile(std::string &data);
    void OnFsReadWriteFile(std::string &data);
    void OnFsCreateFileMapping(std::string& data);
    void OnFsQueryFileInformation(std::string &data);
    void OnRgCreateOpenKey(std::string& data);
    void OnRgSetValueKey(std::string &data);
    void OnRgQueryValueKey(std::string& data);
    void OnRgQueryKey(std::string &data);
};
