...
public:
    ...
    virtual std::string  GetDisplayValue(void) const { return m_DisplayValue; }
    void Reference();
    void Dereference();
public:
...
public:
    CEventFilter_Number(int NumberValue, filter_rel Relation, bool bInclude) : CEventFilter(Relation, bInclude)
    {
        ...
        m_DisplayValue = boost::lexical_cast<std::string>(NumberValue);
    }
public:
    int m_NumberValue;
};
...
{
public:
    CEventFilter_String(std::string & StringValue, filter_rel Relation, bool bInclude) : CEventFilter(Relation, bInclude)
    {
...
{
public:
    CEventFilter_ProcessName(std::string & val, filter_rel Relation, bool bInclude);
...
{
public:
    CEventFilter_ProcessPath(std::string & val, filter_rel Relation, bool bInclude);
...
{
public:
    CEventFilter_EventPath(std::string & val, filter_rel Relation, bool bInclude);
...
{
public:
    CEventFilter_BriefResult(std::string & val, filter_rel Relation, bool bInclude);
